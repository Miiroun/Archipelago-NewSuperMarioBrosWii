...
PatchDetatils = [("star_coin", "Object", "Object")]
#[("openingTitle", os.join( RegionNames[_patcher.region],"Layout","openingTitle" )]


for name, folder_source, folder_patch in PatchDetatils:

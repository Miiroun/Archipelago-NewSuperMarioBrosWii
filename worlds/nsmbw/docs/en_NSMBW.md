...
- 5 Starting checks to make AP happy with random start
...
## Rivvolution ??
In its current state the client doesn't modify the gamefile in any way (just editing the game's live memory). This means that you dont need a mod patch.
...
## Known bugs
 - At start of game and after completing a world the game moves you to the next without you having unlocked it, which breaks logic.
   - The current solution is for you to manually move to a world you have unlocked.

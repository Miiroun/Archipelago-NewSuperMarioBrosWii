...
class RummyGameView(MDRecycleView):
    focused: int = 1
...
class RummyControlsView(BoxLayout):
    pass
...
# Rummy code
class RummyCardWidget(DragBehavior, ButtonBehavior,Image):
    pass
    def __init__(self,texture, **kwargs: dict[str, Any]) -> None:
        super().__init__(**kwargs)
...
class RummyCollection(DragBehavior, Image):
    pass
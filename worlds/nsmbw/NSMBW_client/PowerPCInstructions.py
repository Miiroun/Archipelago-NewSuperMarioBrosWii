...
instru_blr   : bytes = b'\x4E\x80\x00\x20' #4e800020
instru_noop     : bytes = b'\x48\x00\x00\x28' #??? not sure if correct #48000028
instru_li_r3  : bytes = b'\x38\x60'  #li 38 60 00 00 # 4 bits value that is set
instru_li_r0   : bytes = b'\x38\x00'

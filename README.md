...
READ FIRST
[SETUP GUIDE](worlds/nsmbw/docs/setup_en.md)

Then skim though
[Game info](worlds/nsmbw/docs/en_NSMBW.md)
, if you have any issues read the Debug tips first and then ask for help in the archipelago discord. 

LATEST RELEASE
[NSMBW](https://github.com/Miiroun/Archipelago-NewSuperMarioBrosWii/releases/latest)


Check out [worlds/nsmbw](worlds/nsmbw) for the source code, 
and [dev_docs](worlds/nsmbw/dev_files/dev_docs) for the explanation of the code.

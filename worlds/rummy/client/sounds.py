...
class SoundManager:
    ...
    def ensure_config(self) -> None:
        Config.adddefaultsection(RUMMY_NAME)
        Config.setdefault(RUMMY_NAME, "volume", 30)
        self.set_volume_percentage(Config.getint(RUMMY_NAME, "volume"))
    ...
    def set_volume_percentage(self, volume_percentage: float) -> None:
        ...
        if self.volume_percentage != volume_percentage:
            ...
            Config.set(RUMMY_NAME, "volume", volume_percentage_int)
            Config.write()
